...
def fetch_nasa_epic(nasa_token):
    ...
    for nasa_image in response.json():
        ...
        epic_image_url = f"https://api.nasa.gov/EPIC/archive/natural/{formatted_epic_date}/png/{epic_name}.png"
        download_image(epic_image_url, f"epic{epic_name}.png", params=payload)
